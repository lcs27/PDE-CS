...
np.savetxt("U0s.txt",U0s)
np.savetxt("force_U0s.txt",force1)
np.savetxt("max_velocity_U0s.txt",max_velocity1)
...
np.savetxt("Ys.txt",U0s)
np.savetxt("force_Ys.txt",force1)
np.savetxt("max_velocity_Ys.txt",max_velocity1)